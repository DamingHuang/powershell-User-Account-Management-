...
powershell.exe -ExecutionPolicy Bypass -File "\\WIN-PO0QFHEI7V0\CleanDesktop\Administrator\Desktop\users\remove-user.ps1" >> \\WIN-PO0QFHEI7V0\CleanDesktop\Administrator\Desktop\users\errlog.txt 2>&1
